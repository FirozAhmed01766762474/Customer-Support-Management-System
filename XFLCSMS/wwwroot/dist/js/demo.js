...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      ...
      alert('You are using XFL CSMS.\nThis client support management System in currently under development by XFL Software Team!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize XFL CSMS</h5><hr class="mb-2"/>'
  )
