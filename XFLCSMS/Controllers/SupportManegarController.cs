...
{
    public class SupportManegarController : Controller
    {
        private readonly DataContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public SupportManegarController(DataContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> EditTicketttt(MakerView makerView, List<IFormFile> files)
        {
            try
            {
                ...
                if (issue != null)
                {
                    ...
                    return RedirectToAction("AllTicketList", "SupportManegar");
                }
