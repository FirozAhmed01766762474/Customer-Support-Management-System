...
namespace XFLCSMS.Controllers
{
    public class AdminController : Controller
    {
        ...
        {
            //int brokerageId = (int)reportView.search.BrokerageId;
            //string EmployeeName = reportView.search.EmployeeName;
            //DateTime fromDate = (DateTime)reportView.search.FromDate;
            //DateTime toDate = (DateTime)reportView.search.ToDate;
            //string priority = reportView.search.Priority;
            //string assign = reportView.search.AStatus;
